...
const ICON_CHOICES = {
  ...
  poulet: '<svg viewBox="0 0 24 24"><ellipse cx="8.5" cy="19.5" rx="2.5" ry="3" fill="#f57c00"/><ellipse cx="15.5" cy="19.5" rx="2.5" ry="3" fill="#f57c00"/><ellipse cx="8.5" cy="22.5" rx="2" ry="1" fill="#efebe9"/><ellipse cx="15.5" cy="22.5" rx="2" ry="1" fill="#efebe9"/><ellipse cx="4" cy="11.5" rx="2.5" ry="2" fill="#ef6c00" transform="rotate(-10 4 11.5)"/><ellipse cx="20" cy="11.5" rx="2.5" ry="2" fill="#ef6c00" transform="rotate(10 20 11.5)"/><ellipse cx="12" cy="11" rx="7" ry="8" fill="#f9a825"/><path d="M6.5 8c1.5-4 4.5-6 7.5-5.5 2.5.5 4.5 2.5 5 5.5-1-2.5-3-4-5-4.5-2.5-.5-5.5.5-7.5 4.5z" fill="#e65100"/><ellipse cx="10.5" cy="8" rx="2.5" ry="1.5" fill="#ffd54f"/></svg>',
