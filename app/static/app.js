...
const ICON_CHOICES = {
  ...
  poulet: '<svg viewBox="0 0 24 24"><line x1="10.5" y1="14" x2="3" y2="6.5" stroke="#efebe9" stroke-width="2.5" stroke-linecap="round"/><circle cx="2.5" cy="6" r="2.2" fill="#efebe9"/><line x1="13" y1="11" x2="5.5" y2="3.5" stroke="#efebe9" stroke-width="2.5" stroke-linecap="round"/><circle cx="5" cy="3" r="2.2" fill="#efebe9"/><ellipse cx="15" cy="15" rx="8" ry="7" fill="#f4a261"/><path d="M9.5 12 Q14 8 21 12" stroke="#bf4e12" stroke-width="1.3" fill="none" stroke-linecap="round"/><circle cx="14.5" cy="16" r="1.1" fill="#bf4e12"/><circle cx="17" cy="18.5" r="1.1" fill="#bf4e12"/></svg>',
