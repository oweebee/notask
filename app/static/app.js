...
const ICON_CHOICES = {
  ...
  poulet: '<svg viewBox="0 0 24 24"><line x1="13" y1="9" x2="18" y2="3" stroke="#efebe9" stroke-width="2.5" stroke-linecap="round"/><circle cx="18.5" cy="2.5" r="2.2" fill="#efebe9"/><line x1="15.5" y1="10" x2="21" y2="6" stroke="#efebe9" stroke-width="2.5" stroke-linecap="round"/><circle cx="21.5" cy="5.5" r="2.2" fill="#efebe9"/><ellipse cx="10" cy="14" rx="9" ry="7.5" fill="#bf4e0a"/><ellipse cx="11" cy="12" rx="4.5" ry="3.5" fill="#e07820"/><ellipse cx="6.5" cy="16" rx="3.5" ry="2" fill="#8c3808" transform="rotate(-20 6.5 16)"/><ellipse cx="10" cy="21.5" rx="10" ry="1.5" fill="#d0d0d0"/></svg>',
