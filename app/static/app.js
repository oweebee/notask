...
const ICON_CHOICES = {
  ...
  tv: '<svg viewBox="0 0 24 24"><rect x="2.5" y="7.5" width="19" height="11.5" rx="2" fill="#546e7a"/><rect x="4" y="9" width="13" height="7.5" rx="1" fill="#4fc3f7"/><circle cx="19.5" cy="11" r="0.9" fill="#b0bec5"/><circle cx="19.5" cy="14" r="0.9" fill="#b0bec5"/><rect x="7.5" y="19" width="2" height="2.5" rx="0.7" fill="#455a64"/><rect x="14.5" y="19" width="2" height="2.5" rx="0.7" fill="#455a64"/><path d="M10 7.5l-2.5-4M14 7.5l2.5-4" stroke="#90a4ae" stroke-width="1.8" stroke-linecap="round" fill="none"/></svg>',
  ...
  /* ── Cuisine ─────────────────────────────────────────────────── */
  fourchette: '<svg viewBox="0 0 24 24"><rect x="7.2" y="2" width="1.5" height="8" rx="0.7" fill="#90a4ae"/><rect x="10.2" y="2" width="1.5" height="8" rx="0.7" fill="#90a4ae"/><rect x="13.2" y="2" width="1.5" height="8" rx="0.7" fill="#90a4ae"/><rect x="7.2" y="9.5" width="7.5" height="1.5" rx="0.7" fill="#78909c"/><rect x="10.2" y="11" width="1.5" height="11" rx="0.7" fill="#90a4ae"/></svg>',
  couteau: '<svg viewBox="0 0 24 24"><rect x="3.5" y="13" width="3" height="9" rx="1.5" fill="#8d6e63"/><path d="M6 13.5C8 8 15 4 21 4L6 16.5z" fill="#cfd8dc"/><path d="M6 13.5 21 4" stroke="#b0bec5" stroke-width="0.8" fill="none"/></svg>',
  cuilleresoupe: '<svg viewBox="0 0 24 24"><ellipse cx="9" cy="7.5" rx="5.5" ry="5.5" fill="#90a4ae"/><ellipse cx="9" cy="7.5" rx="3.8" ry="3.8" fill="#b0bec5"/><path d="M14 11.5 17 21.5" stroke="#90a4ae" stroke-width="2.2" stroke-linecap="round" fill="none"/></svg>',
  fouet: '<svg viewBox="0 0 24 24"><ellipse cx="12" cy="8" rx="5" ry="6" fill="none" stroke="#ff8a65" stroke-width="1.5"/><path d="M8 5c-1.5 2-1.5 6.5 0 8.5M12 2.5v11.5M16 5c1.5 2 1.5 6.5 0 8.5" stroke="#ff8a65" stroke-width="1.2" stroke-linecap="round" fill="none"/><rect x="11" y="14" width="2" height="8" rx="1" fill="#8d6e63"/></svg>',
  spatule: '<svg viewBox="0 0 24 24"><rect x="11" y="11" width="2" height="11" rx="1" fill="#8d6e63"/><rect x="8" y="3.5" width="8" height="8" rx="1.2" fill="#90a4ae"/><path d="M9 4.5h6M9 6.5h6M9 8.5h6" stroke="#b0bec5" stroke-width="0.9" stroke-linecap="round" fill="none"/></svg>',
  casserole: '<svg viewBox="0 0 24 24"><path d="M4.5 9.5h15v5.5A4.5 4.5 0 0 1 15 19.5H9A4.5 4.5 0 0 1 4.5 15z" fill="#78909c"/><rect x="3.5" y="8" width="17" height="2.5" rx="1.2" fill="#90a4ae"/><rect x="20" y="8.8" width="3.5" height="2" rx="1" fill="#8d6e63"/></svg>',
  poele: '<svg viewBox="0 0 24 24"><ellipse cx="10" cy="14.5" rx="7" ry="5.5" fill="#546e7a"/><ellipse cx="10" cy="13.5" rx="5.5" ry="3.5" fill="#455a64"/><rect x="16.5" y="13" width="6.5" height="2" rx="1" fill="#8d6e63"/></svg>',
  marmite: '<svg viewBox="0 0 24 24"><path d="M5 10.5h14v6A4.5 4.5 0 0 1 14.5 21h-5A4.5 4.5 0 0 1 5 16.5z" fill="#607d8b"/><rect x="3.5" y="9" width="17" height="2.5" rx="1.2" fill="#78909c"/><rect x="2" y="9.5" width="2.5" height="2" rx="1" fill="#78909c"/><rect x="19.5" y="9.5" width="2.5" height="2" rx="1" fill="#78909c"/></svg>',
  four: '<svg viewBox="0 0 24 24"><rect x="2.5" y="3.5" width="19" height="17" rx="1.5" fill="#546e7a"/><rect x="4.5" y="5.5" width="15" height="9" rx="1" fill="#37474f"/><rect x="5.5" y="6.5" width="13" height="7" rx="0.8" fill="#263238"/><circle cx="7.5" cy="17" r="1.2" fill="#90a4ae"/><circle cx="12" cy="17" r="1.3" fill="#ff7043"/><circle cx="16.5" cy="17" r="1.2" fill="#90a4ae"/></svg>',
  frigo: '<svg viewBox="0 0 24 24"><rect x="5" y="2" width="14" height="8.5" rx="1" fill="#90a4ae"/><rect x="5" y="11.5" width="14" height="10.5" rx="1" fill="#b0bec5"/><rect x="4.5" y="10" width="15" height="2" rx="0.5" fill="#607d8b"/><path d="M10 5.5v3M10 15v4" stroke="#78909c" stroke-width="1.5" stroke-linecap="round" fill="none"/></svg>',
  ...
  poulet: '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><image href="data:image/png;base64," x="0" y="0" width="24" height="24"/></svg>',
...
/* Affiche une échéance de façon lisible : « aujourd'hui 14:00 », « 3 août 09:30 ».
   `allDay` (mode journée complète) affiche le jour SANS heure, et le compare
   au jour UTC (isoToUtcDateStr) plutôt qu'au jour local — cf. dateOnlyToIso :
   une échéance journée complète est un jour calendaire pur, encodé en
   minuit UTC, jamais une conversion depuis un fuseau. */
function formatDue(isoString, allDay = false) {
  if (!isoString) return '';
  if (allDay) {
    const jourStr = isoToUtcDateStr(isoString);
    if (!jourStr) return '';
    ...
    if (memeJour(jour, now)) return "aujourd'hui";
    if (memeJour(jour, demain)) return 'demain';
    if (memeJour(jour, hier)) return 'hier';
    return jour.toLocaleDateString('fr-FR', {
      day: 'numeric',
      month: 'short',
      year: jour.getFullYear() === now.getFullYear() ? undefined : 'numeric',
    });
  }
...
/* Échéance ponctuelle ou plage (« période » cochée dans le sélecteur). Une
   ...
   En mode journée complète (`allDay`), jamais d'heure : une plage devient
   simplement « jour début → jour fin ». */
function formatDueRange(isoStart, isoEnd, allDay = false) {
  if (!isoStart) return '';
  const debut = formatDue(isoStart, allDay);
  if (!isoEnd) return debut;
  if (allDay) {
    const finStr = formatDue(isoEnd, true);
    return finStr && finStr !== debut ? `${debut} → ${finStr}` : debut;
  }
...
/* Une échéance est-elle en retard ? Même règle que _bucket() côté serveur
   (app/routers/tasks.py) — dupliquée ici uniquement pour l'affichage
   immédiat d'une carte fraîchement modifiée, avant tout aller-retour
   réseau. En mode journée complète, le retard n'est réel qu'une fois le
   DERNIER jour de la période totalement écoulé (minuit UTC suivant) : le
   comparer à `due_at` directement (minuit du jour même) marquerait la
   tâche en retard dès la première seconde du jour. */
function estEnRetard(dueAt, dueEndAt, allDay) {
  if (!dueAt) return false;
  const now = new Date();
  if (allDay) {
    const finIso = dueEndAt || dueAt;
    const fin = new Date(finIso);
    if (Number.isNaN(fin.getTime())) return false;
    const finExclusive = new Date(fin.getTime() + 24 * 60 * 60 * 1000);
    return now >= finExclusive;
  }
...
/* Mode « journée complète » (voir NoteBase.all_day côté serveur) : une
   échéance journée entière n'a AUCUN sens horaire, donc pas de conversion
   depuis un fuseau local comme partsToIso — on encode directement le jour
   choisi en minuit UTC. C'est ce qui permet de relire ensuite ce jour sans
   jamais se soucier du fuseau du navigateur qui rouvre le sélecteur (voir
   isoToUtcDateStr, son inverse). */
function dateOnlyToIso(dateStr) {
  if (!dateStr) return null;
  return `${dateStr}T00:00:00.000Z`;
}

/* Inverse de dateOnlyToIso : relit le jour calendaire encodé, en UTC — PAS
   en heure locale (isoToParts), qui déciderait du mauvais jour dans tout
   fuseau où minuit UTC ne tombe pas le même jour civil (à l'ouest de
   l'UTC). Utilisée uniquement pour rouvrir le sélecteur sur une échéance
   déjà enregistrée en mode journée complète. */
function isoToUtcDateStr(isoString) {
  if (!isoString) return null;
  const d = new Date(isoString);
...
function openCalPopup(anchor, currentIso, onChange, currentEndIso = null, currentAllDay = false, currentRecur = null) {
  ...
  // En mode journée complète, la date affichée doit se relire en UTC (voir
  // isoToUtcDateStr) — parts/endParts (isoToParts, en heure LOCALE) donnerait
  // le mauvais jour dans tout fuseau à l'ouest de l'UTC. Ne s'applique qu'à
  // la réouverture d'une échéance déjà enregistrée ainsi ; le reste du temps
  // (bascule en cours d'édition) le champ date garde la valeur déjà choisie.
  const startDateStr = (currentAllDay && isoToUtcDateStr(currentIso)) || parts.date;
  const endDateStr = (currentAllDay && isoToUtcDateStr(currentEndIso)) || endParts.date;

  const pop = document.createElement('div');
  pop.className = 'cal-popup';
  const champsHeure = (classe) => `
    <span class="cal-popup-heure">
  ...
  pop.innerHTML = `
    ...
    <label class="cal-popup-periode cal-popup-allday">
      <input type="checkbox" class="cal-popup-allday-toggle">
  ...
  // Journée complète : masque les champs d'heure (début ET fin, qu'elle
  // soit visible ou non) — le choix ne porte plus que sur des jours.
  allDayToggle.checked = !!currentAllDay;
  const appliquerAllDay = () => {
    heureEls.forEach((el) => { el.hidden = allDayToggle.checked; });
  };
  appliquerAllDay();
  allDayToggle.onchange = appliquerAllDay;
  ...
  const currentValue = () => (allDayToggle.checked
    ? dateOnlyToIso(dateInput.value)
    : partsToIso(dateInput.value, hourSelect.value, minSelect.value));
  const currentEndValue = () => {
    if (!toggle.checked) return null;
    return allDayToggle.checked
      ? dateOnlyToIso(dateEnd.value)
      : partsToIso(dateEnd.value, hourEnd.value, minEnd.value);
  };
...
const ICON_THEMES = [
  {
    titre: 'Général',
    cles: ['star', 'heart', 'flag', 'idea', 'gift', 'money', 'target', 'gem', 'key', 'lock', 'warning', 'document', 'trombone', 'book', 'school', 'work', 'home', 'shopping', 'travel', 'globe', 'anniversaire', 'fete', 'vacances', 'music', 'euro', 'dollar'],
  },
  {
  ...
  {
    titre: 'Fun & perso',
    cles: ['bite', 'nichons', 'chartreuse', 'hellfest'],
  },
  {
    titre: 'notask',
...
const ICON_MOTS = {
  ...
  film: 'film cinéma clap plateau',
  series: 'série télévisée épisodes saison',
  fourchette: 'fourchette couverts cuisine', couteau: 'couteau cuisine couverts lame',
  cuilleresoupe: 'cuillère soupe couverts cuisine', fouet: 'fouet batteur pâtisserie',
  spatule: 'spatule ustensile cuisine', casserole: 'casserole cuisine batterie',
  poele: 'poêle sauteuse frire cuisine', marmite: 'marmite cocotte grande casserole',
  four: 'four cuisson chaud forno', frigo: 'frigo réfrigérateur frigidaire',
  oeuf: 'oeuf œuf cuisine ingrédient', fromage: 'fromage camembert brie',
  ...
  excel: 'excel microsoft tableur calcul',
  cart: 'caddie chariot panier achat courses',
...
function renderLabelsDrawer() {
  ...
  for (const l of state.labels) {
    ...
    // quelles, il n'y a qu'une palette dans toute l'application).
  ...
  for (const n of state.notes) {
    ...
    if (n.due_at) {
      ...
      inner += `<div class="note-due ${late ? 'late' : ''} ${n.done ? 'done' : ''}">
        ...
        ${ICONS.clock}<span>${formatDueRange(n.due_at, n.due_end_at, n.all_day)}</span>
      </div>`;
    }
...
function majEcheanceLigne(bloc, iso, finIso, allDay = false, recur = null) {
  ...
  if (cal) {
    ...
    cal.title = iso ? formatDueRange(iso, finIso, allDay) : 'Dater cette ligne en fait une tâche';
  }
}
